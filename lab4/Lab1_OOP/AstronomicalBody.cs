...
namespace Lab1_OOP
{
    ...
    [Serializable]
    public class AstronomicalBody: ICoordinates<AstronomicalBody>, ICharacteristic<AstronomicalBody>, IComparable<AstronomicalBody>, IDisposable
    {
        ...
        ~AstronomicalBody()
        {
            Console.WriteLine("Deleting a body...");
        }
